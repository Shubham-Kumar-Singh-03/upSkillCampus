...
public class SignupFile3 extends JFrame implements ActionListener{
    ...
    SignupFile3(String formno){
        ...
        // Information for user to understand
        // -------------------------------------------------------------------------------------------------
        l6 = new JLabel("It would appear on ATM Card/Cheque Book and Statements");
        l6.setFont(new Font("Raleway", Font.BOLD, 12));
        l6.setBounds(330,260,500,20);
        add(l6);
        ...
        try{
            if(ae.getSource()==b1){
                ...
                if(atype.equals("")){
                    ...
                    String q1 = "insert into signup3 (Form_NO , Account_Type , Card_NO , PIN , Facility) values ('"+formno+"','"+atype+"','"+cardno+"','"+pin+"','"+facility+"')";  
                    String q2 = "insert into login (Form_No , Card_No , PIN) values ('"+formno+"','"+cardno+"','"+pin+"')";
    ...
    public static void main(String[] args){
        new SignupFile3("").setVisible(true);
    }
